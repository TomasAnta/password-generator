...
export const Button = forwardRef<any, ButtonProps>(({ variant, children, className, onClick, ...props }, ref) => (
    <StyledButton ref={ref} {...props} variant={variant} className={className} onClick={onClick}>
        {children}
    </StyledButton>
));
